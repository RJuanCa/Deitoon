...
<body id="body">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $mostrar['email_usu'] ?></th>
      <td><?php echo $mostrar['clave'] ?></th>
      <td><?php echo $mostrar['nombre'] ?></th>
      <td><?php echo $mostrar['apellido'] ?></th>
      <td><?php echo $mostrar['id_cargo'] ?></th>
      <td><?php echo $mostrar['activo'] ?></th>
      <td>
      <a class="btn btn-success" href="usuario_editar.php?id=<?php echo $mostrar['id_usuario'] ?>">Editar</a>
